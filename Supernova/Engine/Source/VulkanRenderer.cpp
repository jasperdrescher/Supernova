...
void VulkanRenderer::CreatePipeline()
{
	...
	vkPipelineShaderStages[0].module = LoadSPIRVShader(VulkanTools::GetShadersPath() + "triangle/triangle_vert.spv");
	...
	vkPipelineShaderStages[1].module = LoadSPIRVShader(VulkanTools::GetShadersPath() + "triangle/triangle_frag.spv");
...
void VulkanRenderer::CreateVkInstance()
{
	...
	if (VulkanTools::gShaderDirectory == "Slang")
	{
