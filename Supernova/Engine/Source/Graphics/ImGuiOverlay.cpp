...
ImGuiKey KeyToImGuiKey(int aKeycode, int aScancode)
{
	IM_UNUSED(aScancode);
	switch (aKeycode)
	{
...
void ImGuiOverlay::OnKeyCallback(int aKeycode, int aScancode, int aAction, int /*aMods*/)
{
	...
	aKeycode = TranslateUntranslatedKey(aKeycode, aScancode);

	const ImGuiKey imguiKey = KeyToImGuiKey(aKeycode, aScancode);
